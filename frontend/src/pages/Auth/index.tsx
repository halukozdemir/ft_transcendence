      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="w-full max-w-md space-y-12">
          ...
          <div className="relative flex items-center">
            ...
            <div className="px-3 text-xs text-slate-500 uppercase tracking-widest">Veya şununla devam et</div>
            <div className="flex-1 border-t border-white/10"></div>
          </div>

          {/* OAuth 42 Button */}
          <button
            className="cursor-pointer w-full flex items-center justify-center gap-3 rounded-lg border-2 border-white/10 hover:border-white/20 bg-white/5 hover:bg-white/10 px-4 py-3 text-sm font-semibold text-white transition-all shadow-lg hover:shadow-xl"
